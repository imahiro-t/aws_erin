defmodule Example do
  def get_s3_object(bucket_name, file_name) do
    AwsErin.S3.get_object(bucket_name, file_name, aws_region: "ap-northeast-1")
  end

  def put_s3_object(bucket_name, file_name, body) do
    AwsErin.S3.put_object(bucket_name, file_name, body, aws_region: "ap-northeast-1")
  end

  def delete_s3_object(bucket_name, file_name) do
    AwsErin.S3.delete_object(bucket_name, file_name, aws_region: "ap-northeast-1")
  end
  ...
  def get_dynamodb_item(value) do
    ...
    AwsErin.DynamoDB.get_item(request, aws_region: "ap-northeast-1")
  end
  ...
  def put_dynamodb_item(value) do
    ...
    AwsErin.DynamoDB.put_item(request, aws_region: "ap-northeast-1")
  end
  ...
  def delete_dynamodb_item(value) do
    ...
    AwsErin.DynamoDB.delete_item(request, aws_region: "ap-northeast-1")
  end
end
